...
void loop()
{
  ...
  float handguide_position = sensorValue/4;
          ...
          if (hall_A1_counter<=300) my_current_position = MY_POSITION_T0;
          if (hall_A1_counter>300&& hall_A1_counter<=1000) my_current_position = MY_POSITION_T1;
          if (hall_A1_counter>1001&& hall_A1_counter<=3000) my_current_position = MY_POSITION_T2;
...
void hall_A()                        　// interrupt 0 triggs this 
{ 
...
{
  digitalWrite(DIR_C, LOW);
  analogWrite(PWM_C, duty_c_backward);
}
